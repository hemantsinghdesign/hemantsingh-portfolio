...
export const tadkaTrail: ProjectInput = {
  ...
  /* The working out, on its own page. Kept out of the case study so the
     argument stays readable — a reader who wants the depth is one click
     away, and a reader who does not is not scrolling past it. */
  research: {
    intro:
